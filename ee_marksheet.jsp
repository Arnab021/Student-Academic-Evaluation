...
try {
	...
	"select * from student_info,ee where student_info.reg_no=ee.reg_no and student_info.reg_no='"
			+ registration_number + "'");
	while (rs.next()) {
%>
<!DOCTYPE html>
	...
	<div class="container">
		...
		<table BORDER="1XP">
			<tr style="background-color: rgb(30, 255, 0);">
				<td colspan="2"><b>ROLL NUMBER: </b> DCCPEES3</td>
			...
			<tr>
				<th>CCP101</th>
				<th>Introduction to Electric Genaric System</th>
				<th>100</th>
				<th>40</th>
			...
			<tr>
				<th>CCP103</th>
				<th>Electrical and Electronic measurement</th>
				<th>100</th>
				<th>40</th>
			...
			<tr>
				<th>CCP104</th>
				<th>DC Machines and Transformers</th>
				<th>100</th>
				<th>40</th>
