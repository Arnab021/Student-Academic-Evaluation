...
try {
	...
	"select * from student_info,me where student_info.reg_no=me.reg_no and student_info.reg_no='"
			+ registration_number + "'");
	while (rs.next()) {
%>
<!DOCTYPE html>
	...
	<div class="container">
		...
		<table BORDER="1XP">
			<tr style="background-color: rgb(30, 255, 0);">
				<td colspan="2"><b>ROLL NUMBER: </b> DCCPMES3</td>
			...
			<tr>
				<th>CCP101</th>
				<th>Mechanical Engineering Drawing</th>
				<th>100</th>
				<th>40</th>
			...
			<tr>
				<th>CCP102</th>
				<th>Mechanical Engineering Materials</th>
				<th>100</th>
				<th>40</th>
			...
			<tr>
				<th>CCP104</th>
				<th>Manufacturing Processes-1</th>
				<th>100</th>
				<th>40</th>
